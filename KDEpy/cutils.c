 ...
 */
  ...
  __pyx_t_10 = __pyx_memoryview_fromslice(__pyx_v_result, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 39, __pyx_L1_error)
...
static PyObject *__pyx_pw_6cutils_3iterate_data(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("iterate_data (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_result)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("iterate_data", 1, 2, 2, 1); __PYX_ERR(0, 44, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "iterate_data") < 0)) __PYX_ERR(0, 44, __pyx_L3_error)
      }
    ...
    __pyx_v_transformed_data = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_transformed_data.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_result = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_result.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("iterate_data", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 44, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 *     Iterate over data points and assign linear weights to nearest grid points.
 */
  __pyx_tuple__24 = PyTuple_Pack(9, __pyx_n_s_transformed_data, __pyx_n_s_result, __pyx_n_s_length_data, __pyx_n_s_length_result, __pyx_n_s_integral, __pyx_n_s_data_point, __pyx_n_s_weight, __pyx_n_s_fractional, __pyx_n_s_i); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(0, 44, __pyx_L1_error)
 ...
 *     Iterate over data points and assign linear weights to nearest grid points.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6cutils_3iterate_data, NULL, __pyx_n_s_cutils); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_iterate_data, __pyx_t_1) < 0) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
