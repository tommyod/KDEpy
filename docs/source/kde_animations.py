...
def main():
    ...
    ax.scatter(data, np.zeros_like(data), color="red", marker="|", zorder=10, label="Data")
    ...
    anim.save(os.path.join(save_path, r"KDE_bw_animation.gif"), dpi=80, writer="imagemagick")
    plt.show()
